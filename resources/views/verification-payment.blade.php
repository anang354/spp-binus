...
<body class="bg-sky-600 min-h-screen flex flex-col items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-lg">
    <div>
        <img src="{{ asset('storage/' . $pengaturan->logo_sekolah) }}" alt="Logo Sekolah" class="lg:h-64 h-32 mx-auto mb-4">
        <p class="text-gray-600 lg:text-2xl font-medium text-xl pb-4 text-center">{{ $pengaturan['nama_sekolah'] }}</p>
    ...
    <div class="max-w-md text-sm lg:text-base w-full bg-green-50 rounded-lg text-green-700 inset-ring inset-ring-green-600/20 p-6">
        <div class="w-full flex flex-row mb-6 gap-4">
            ...
            <div class="font-medium">
                ...
                <p class="mb-2">{{ $pembayaran[0]['siswa']['nama_siswa'] }}</p>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-500">Ada kesalahan pembayaran? <a href="https://wa.me/{{ $pengaturan->telepon_sekolah }}" class="text-blue-600 hover:text-blue-500">Konfirmasi Admin</a></p>
        </div>
    </div>
    </div>
</body>
