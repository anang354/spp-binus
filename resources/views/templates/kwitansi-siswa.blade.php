...
<body>
    ...
    <table style="width: 100%; font-size: 10pt; margin-top: 10px;">
        <tbody>
            <tr>
                <td>Nama : {{ $pembayaran[0]['siswa']['nama_siswa'] }}</td>
    ...
    <table class="tb-tagihan">
        ...
        <tbody>
            ...
            @endphp
            <tr>
                <td> {{$itemPembayaran['tagihan']['nama_tagihan']}} {{ \App\Models\Tagihan::BULAN[$itemPembayaran['tagihan']['periode_bulan']].' '.$itemPembayaran['tagihan']['periode_tahun'] }}</td>
